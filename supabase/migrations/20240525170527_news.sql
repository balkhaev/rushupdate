...
CREATE TRIGGER set_news_user_tracking
    BEFORE INSERT OR UPDATE ON public.news
    FOR EACH ROW
...
----------------
-- create policy "All logged in users can select" on public.news
--     for select
--     to authenticated
--     using (true);
...
----------------
-- create policy "All authenticated and anonymous users can select" on public.news
--     for select
...
--------------
-- create policy "Account members can select" on public.news
--     for select
--     to authenticated
--     using (
...
----------------
-- create policy "Account members can insert" on public.news
--     for insert
--     to authenticated
--     with check (
--     (account_id IN ( SELECT basejump.get_accounts_with_role()))
...
---------------
-- create policy "Account members can update" on public.news
--     for update
--     to authenticated
--     using (
--     (account_id IN ( SELECT basejump.get_accounts_with_role()))
...
----------------
-- create policy "Account members can delete" on public.news
--     for delete
--     to authenticated
--     using (
--     (account_id IN ( SELECT basejump.get_accounts_with_role()))
...
----------------
-- create policy "Account owners can delete" on public.news
--     for delete
--     to authenticated
--     using (
